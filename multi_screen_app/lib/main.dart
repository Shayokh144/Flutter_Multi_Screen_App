...
class DisplayManagerScreen extends StatefulWidget {
  ...
  @override
  DisplayManagerScreenState createState() => DisplayManagerScreenState();
}

class DisplayManagerScreenState extends State<DisplayManagerScreen> {
        ...
        ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              return SizedBox(
                ...
                child: Center(
                    child: Text(
                        ' id : ${displays[index]?.displayId} name: ${displays[index]?.name}')),
              );
            }),
        const Divider()
      ],
